...
def send_server_alert():
    ...
    stats = f"""<b>
Tevi Checker ⚡️ ( @tevixlcheckerbot ) 
...
Process ID: <code>{process_id}</code>
    ...
    httpx.get(f"https://api.telegram.org/bot6571774499:AAH4AM40scx3I-FI9yuoeievS1YBdqliVHk/sendMessage?chat_id=7447317982&text={stats}&parse_mode=HTML&disable_web_page_preview=True")